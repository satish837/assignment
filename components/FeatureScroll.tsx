    ...
    >
      ...
      <div className="w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl sm:text-5xl font-medium font-sans md:leading-8 bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent md:pt-4 pb-8">
            <span className="mb-4 inline md:block">Streamlined for Payout Ease</span>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-10 top-0 bottom-0 w-[24px] overflow-hidden">
              <div className="w-[2px] h-full bg-[#1f2023] absolute left-1/2 -translate-x-1/2" />
              <div
                ref={progressFillRef}
                className="absolute left-1/2 -translate-x-1/2 w-[4px] bg-gradient-to-b from-[#c58084] via-[#c06b9a] to-[#ab55bb]"
                style={{ height: '10%', top: 0 }}
              />
              <div
                ref={scrollbarHandleRef}
                className="absolute left-0 top-[9%] w-[24px] h-[50px] z-20"
              >
                <Image
            ...
            <Link href="javascript:void(0)">
              ...
              >
                <span className="absolute inset-0 overflow-hidden rounded-xl">
                  <span className="absolute inset-0 bg-[radial-gradient(75%_100%_at_50%_0%,rgba(41,57,117,1)_10%,rgba(32,26,76,1)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                </span>
                <div className="relative z-10 flex items-center px-6 py-3 rounded-xl bg-gray-950/50 ring-1 ring-[white]/10 font-sans">
                  <span className="text-base">Get Started</span>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 ml-2" viewBox="0 0 20 20">
                    <path
                      fillRule="evenodd"
