...
export default function PaymentsFeature() {
  return (
    <section className="w-full text-white flex items-center justify-center relative">
      <div className="w-[85%] grid grid-cols-1 md:grid-cols-2 items-start relative">
        {/* Left Side */}
        <motion.div
        ...
        >
          ...
          <div className="relative z-9">
            ...
            <h2 className="text-4xl sm:text-5xl font-medium font-sans leading-tight bg-gradient-to-r from-white to-slate-300 bg-clip-text text-transparent mb-4">
              <span className="block pb-3">Simplify the</span>
              <span className="block pb-3">payments process</span>
            </h2>
